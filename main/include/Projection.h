...
class Projection{
public:
	vector<Point> nodes[50]/*! Array of 2d points denoting projection of all the vertices of the 3d model on the given projection plane*/;
	...
	Plane plane;	
	void addEdge(Point src,Point dest)/*! Function for adding a edge between two 2d points.*/;
